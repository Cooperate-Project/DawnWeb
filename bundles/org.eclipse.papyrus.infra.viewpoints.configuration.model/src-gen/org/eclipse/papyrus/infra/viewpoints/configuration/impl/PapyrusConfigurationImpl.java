...
public class PapyrusConfigurationImpl extends ArchitectureFrameworkImpl implements PapyrusConfiguration {
			...
			if (defaultStakeholder != oldDefaultStakeholder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ConfigurationPackage.PAPYRUS_CONFIGURATION__DEFAULT_STAKEHOLDER, oldDefaultStakeholder,
							defaultStakeholder));
			}
		}
	...
	public EPackage getMetamodel() {
		if (metamodel != null && metamodel.eIsProxy()) {
			...
			if (metamodel != oldMetamodel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ConfigurationPackage.PAPYRUS_CONFIGURATION__METAMODEL, oldMetamodel, metamodel));
			}
		}
		return metamodel;
	}
	...
	public void setMetamodel(EPackage newMetamodel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PAPYRUS_CONFIGURATION__METAMODEL,
	...
	public EList<Category> getCategories() {
		if (categories == null) {
			categories = new EObjectContainmentEList<Category>(Category.class, this,
					ConfigurationPackage.PAPYRUS_CONFIGURATION__CATEGORIES);
		}
		return categories;
	}
