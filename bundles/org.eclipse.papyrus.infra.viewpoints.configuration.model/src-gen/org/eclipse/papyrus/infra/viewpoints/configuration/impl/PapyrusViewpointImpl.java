...
public class PapyrusViewpointImpl extends ArchitectureViewpointImpl implements PapyrusViewpoint {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ConfigurationPackage.PAPYRUS_VIEWPOINT__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(PapyrusViewpoint newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PAPYRUS_VIEWPOINT__PARENT,
					oldParent, parent));
	}
