...
public class AssistantRuleImpl extends RuleImpl implements AssistantRule {
	...
	public void setElementTypeID(String newElementTypeID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.ASSISTANT_RULE__ELEMENT_TYPE_ID,
					oldElementTypeID, elementTypeID));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ConfigurationPackage.ASSISTANT_RULE__ELEMENT_TYPE_ID:
			return ELEMENT_TYPE_ID_EDEFAULT == null ? elementTypeID != null
					: !ELEMENT_TYPE_ID_EDEFAULT.equals(elementTypeID);
		}
