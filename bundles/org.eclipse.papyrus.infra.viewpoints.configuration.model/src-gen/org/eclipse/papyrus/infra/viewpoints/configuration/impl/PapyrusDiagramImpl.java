...
public class PapyrusDiagramImpl extends PapyrusViewImpl implements PapyrusDiagram {
	...
	public void setCustomPalette(String newCustomPalette) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PAPYRUS_DIAGRAM__CUSTOM_PALETTE,
					oldCustomPalette, customPalette));
	}
	...
	public void setCustomStyle(String newCustomStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PAPYRUS_DIAGRAM__CUSTOM_STYLE,
	...
	public EList<ChildRule> getChildRules() {
		if (childRules == null) {
			childRules = new EObjectContainmentEList<ChildRule>(ChildRule.class, this,
					ConfigurationPackage.PAPYRUS_DIAGRAM__CHILD_RULES);
		}
		return childRules;
	}
	...
	public EList<PaletteRule> getPaletteRules() {
		if (paletteRules == null) {
			paletteRules = new EObjectContainmentEList<PaletteRule>(PaletteRule.class, this,
					ConfigurationPackage.PAPYRUS_DIAGRAM__PALETTE_RULES);
		}
		return paletteRules;
	}
	...
	public EList<AssistantRule> getAssistantRules() {
		if (assistantRules == null) {
			assistantRules = new EObjectContainmentEList<AssistantRule>(AssistantRule.class, this,
					ConfigurationPackage.PAPYRUS_DIAGRAM__ASSISTANT_RULES);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ConfigurationPackage.PAPYRUS_DIAGRAM__CUSTOM_PALETTE:
			return CUSTOM_PALETTE_EDEFAULT == null ? customPalette != null
					: !CUSTOM_PALETTE_EDEFAULT.equals(customPalette);
		case ConfigurationPackage.PAPYRUS_DIAGRAM__CUSTOM_STYLE:
