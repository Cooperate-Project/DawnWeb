...
public class ChildRuleImpl extends RuleImpl implements ChildRule {
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConfigurationPackage.CHILD_RULE__ELEMENT,
							oldElement, element));
			}
		}
		return element;
	...
	public void setElement(EClass newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CHILD_RULE__ELEMENT, oldElement,
					element));
	}
	...
	public EList<EClass> getStereotypes() {
		if (stereotypes == null) {
			stereotypes = new EObjectResolvingEList<EClass>(EClass.class, this,
					ConfigurationPackage.CHILD_RULE__STEREOTYPES);
		}
		return stereotypes;
	}
	...
	public EClass getOrigin() {
		if (origin != null && origin.eIsProxy()) {
			...
			if (origin != oldOrigin) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConfigurationPackage.CHILD_RULE__ORIGIN,
							oldOrigin, origin));
			}
		}
		return origin;
	...
	public void setOrigin(EClass newOrigin) {
		...
		origin = newOrigin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.CHILD_RULE__ORIGIN, oldOrigin,
					origin));
	}
	...
	public EList<PathElement> getInsertionPath() {
		if (insertionPath == null) {
			insertionPath = new EObjectContainmentEList<PathElement>(PathElement.class, this,
					ConfigurationPackage.CHILD_RULE__INSERTION_PATH);
		}
