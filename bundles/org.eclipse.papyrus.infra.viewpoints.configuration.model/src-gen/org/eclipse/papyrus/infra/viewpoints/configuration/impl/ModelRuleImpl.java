...
public class ModelRuleImpl extends RuleImpl implements ModelRule {
	...
	public EList<ConstraintDescriptor> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentWithInverseEList<ConstraintDescriptor>(ConstraintDescriptor.class, this,
					ConfigurationPackage.MODEL_RULE__CONSTRAINTS, ConstraintsPackage.CONSTRAINT_DESCRIPTOR__DISPLAY);
		}
		return constraints;
	}
	...
	public void setElementMultiplicity(int newElementMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.MODEL_RULE__ELEMENT_MULTIPLICITY,
					oldElementMultiplicity, elementMultiplicity));
	}
	...
	public EClass getElement() {
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConfigurationPackage.MODEL_RULE__ELEMENT,
							oldElement, element));
			}
		}
		return element;
	...
	public void setElement(EClass newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.MODEL_RULE__ELEMENT, oldElement,
					element));
	}
	...
	public EList<EClass> getStereotypes() {
		if (stereotypes == null) {
			stereotypes = new EObjectResolvingEList<EClass>(EClass.class, this,
					ConfigurationPackage.MODEL_RULE__STEREOTYPES);
		}
		return stereotypes;
	}
	...
	public void setMultiplicity(int newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.MODEL_RULE__MULTIPLICITY,
