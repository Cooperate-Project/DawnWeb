...
public class RootAutoSelectImpl extends MinimalEObjectImpl.Container implements RootAutoSelect {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ConfigurationPackage.ROOT_AUTO_SELECT__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(EReference newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.ROOT_AUTO_SELECT__FEATURE,
					oldFeature, feature));
	}
