...
public class ModelAutoCreateImpl extends MinimalEObjectImpl.Container implements ModelAutoCreate {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ConfigurationPackage.MODEL_AUTO_CREATE__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(EReference newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.MODEL_AUTO_CREATE__FEATURE,
					oldFeature, feature));
	}
	...
	public void setCreationType(String newCreationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.MODEL_AUTO_CREATE__CREATION_TYPE,
					oldCreationType, creationType));
	}
