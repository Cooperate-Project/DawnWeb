...
public class PapyrusViewImpl extends ModelKindImpl implements PapyrusView {
	...
	public void setIcon(String newIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PAPYRUS_VIEW__ICON, oldIcon,
					icon));
	}
	...
	public PapyrusView getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConfigurationPackage.PAPYRUS_VIEW__PARENT,
							oldParent, parent));
			}
		}
		return parent;
	...
	public void setParent(PapyrusView newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PAPYRUS_VIEW__PARENT, oldParent,
					parent));
	}
	...
	public EList<EPackage> getProfiles() {
		if (profiles == null) {
			profiles = new EObjectResolvingEList<EPackage>(EPackage.class, this,
					ConfigurationPackage.PAPYRUS_VIEW__PROFILES);
		}
		return profiles;
	}
	...
	public EList<ModelRule> getModelRules() {
		if (modelRules == null) {
			modelRules = new EObjectContainmentEList<ModelRule>(ModelRule.class, this,
					ConfigurationPackage.PAPYRUS_VIEW__MODEL_RULES);
		}
		return modelRules;
	}
	...
	public EList<OwningRule> getOwningRules() {
		if (owningRules == null) {
			owningRules = new EObjectContainmentEList<OwningRule>(OwningRule.class, this,
					ConfigurationPackage.PAPYRUS_VIEW__OWNING_RULES);
		}
		return owningRules;
	}
	...
	public void setImplementationID(String newImplementationID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.PAPYRUS_VIEW__IMPLEMENTATION_ID,
	...
	public EList<Category> getCategories() {
		if (categories == null) {
			categories = new EObjectResolvingEList<Category>(Category.class, this,
					ConfigurationPackage.PAPYRUS_VIEW__CATEGORIES);
		}
		return categories;
	}
