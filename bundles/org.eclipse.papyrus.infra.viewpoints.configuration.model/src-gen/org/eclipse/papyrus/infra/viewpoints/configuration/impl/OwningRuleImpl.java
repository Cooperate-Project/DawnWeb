...
public class OwningRuleImpl extends RuleImpl implements OwningRule {
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConfigurationPackage.OWNING_RULE__ELEMENT,
							oldElement, element));
			}
		}
		return element;
	...
	public void setElement(EClass newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.OWNING_RULE__ELEMENT, oldElement,
					element));
	}
	...
	public EList<EClass> getStereotypes() {
		if (stereotypes == null) {
			stereotypes = new EObjectResolvingEList<EClass>(EClass.class, this,
					ConfigurationPackage.OWNING_RULE__STEREOTYPES);
		}
		return stereotypes;
	}
	...
	public void setMultiplicity(int newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.OWNING_RULE__MULTIPLICITY,
	...
	public EList<ModelAutoCreate> getNewModelPath() {
		if (newModelPath == null) {
			newModelPath = new EObjectContainmentEList<ModelAutoCreate>(ModelAutoCreate.class, this,
					ConfigurationPackage.OWNING_RULE__NEW_MODEL_PATH);
		}
		return newModelPath;
	}
	...
	public EList<RootAutoSelect> getSelectDiagramRoot() {
		if (selectDiagramRoot == null) {
			selectDiagramRoot = new EObjectContainmentEList<RootAutoSelect>(RootAutoSelect.class, this,
					ConfigurationPackage.OWNING_RULE__SELECT_DIAGRAM_ROOT);
		}
